...
package com.envimate.mapmate.scanner.builder.validation;

import java.util.UUID;

import static com.envimate.mapmate.scanner.builder.validation.CustomTypeValidationException.customTypeValidationException;
