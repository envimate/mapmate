...
import com.envimate.mapmate.scanner.builder.models.constructor.GroupTicketRequest;
import com.envimate.mapmate.scanner.builder.models.constructor.Name;
import com.envimate.mapmate.scanner.builder.models.conventional.Body;
import com.envimate.mapmate.scanner.builder.models.conventional.Email;
import com.envimate.mapmate.scanner.builder.models.conventional.EmailAddress;
import com.envimate.mapmate.scanner.builder.models.conventional.Subject;
import com.envimate.mapmate.scanner.builder.models.conventionalwithclassnamefactories.EmailDto;
import com.envimate.mapmate.scanner.builder.validation.CustomTypeValidationException;
import com.google.gson.Gson;
import org.junit.jupiter.api.Test;

import static com.envimate.mapmate.scanner.builder.models.conventionalwithclassnamefactories.Body.body;
import static com.envimate.mapmate.scanner.builder.models.conventionalwithclassnamefactories.EmailAddress.anEmailAddress;
import static com.envimate.mapmate.scanner.builder.models.conventionalwithclassnamefactories.EmailDto.emailDto;
import static com.envimate.mapmate.scanner.builder.models.conventionalwithclassnamefactories.Subject.aSubject;
...
public final class ConventionalBuilderTest {
    ...
    public static MapMate theConventionalMapMateInstance() {
        ...
        return MapMate.aMapMate("com.envimate.mapmate.scanner.builder.models.conventional",
                "com.envimate.mapmate.scanner.builder.models.conventionalwithclassnamefactories",
                "com.envimate.mapmate.scanner.builder.models.constructor")
