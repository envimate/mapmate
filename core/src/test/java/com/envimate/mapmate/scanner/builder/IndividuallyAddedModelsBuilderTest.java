...
import com.envimate.mapmate.scanner.builder.models.customconvention.Body;
import com.envimate.mapmate.scanner.builder.models.customconvention.Email;
import com.envimate.mapmate.scanner.builder.models.customconvention.EmailAddress;
import com.envimate.mapmate.scanner.builder.models.customconvention.Subject;
import com.envimate.mapmate.scanner.builder.validation.CustomTypeValidationException;
import com.google.gson.Gson;
import org.junit.jupiter.api.Test;

import static com.envimate.mapmate.scanner.builder.conventional.ConventionalDetectors.conventionalDetector;
import static com.envimate.mapmate.scanner.builder.recipes.manualregistry.ManualRegistry.manuallyRegisteredTypes;
...
public final class IndividuallyAddedModelsBuilderTest {
    ...
    public static final com.envimate.mapmate.scanner.builder.models.conventional.Email CONVENTIONAL_EMAIL =
            com.envimate.mapmate.scanner.builder.models.conventional.Email.deserialize(
                    com.envimate.mapmate.scanner.builder.models.conventional.EmailAddress.fromStringValue("sender@example.com"),
                    com.envimate.mapmate.scanner.builder.models.conventional.EmailAddress.fromStringValue("receiver@example.com"),
                    com.envimate.mapmate.scanner.builder.models.conventional.Subject.fromStringValue("Hello"),
                    com.envimate.mapmate.scanner.builder.models.conventional.Body.fromStringValue("Hello World!!!")
            );
        ...
        return MapMate.aMapMate()
                .usingRecipe(manuallyRegisteredTypes()
                        .withSerializedObjects(
                                com.envimate.mapmate.scanner.builder.models.conventional.Email.class
                        )
                        .withCustomPrimitives(
                                com.envimate.mapmate.scanner.builder.models.conventional.EmailAddress.class,
                                com.envimate.mapmate.scanner.builder.models.conventional.Subject.class,
                                com.envimate.mapmate.scanner.builder.models.conventional.Body.class)
                )
    ...
    public void testEmailDeserializationConventional() {
        final com.envimate.mapmate.scanner.builder.models.conventional.Email result = theIndividuallyAddedTypesMapMateConventional()
                .deserializer()
                .deserializeJson(EMAIL_JSON, com.envimate.mapmate.scanner.builder.models.conventional.Email.class);
