...
import static com.envimate.mapmate.scanner.builder.conventional.ConventionalDefinitionFactories.nameAndConstructorBasedCustomPrimitiveDefinitionFactory;
import static com.envimate.mapmate.scanner.builder.detection.SimpleDetector.detector;
import static com.envimate.mapmate.scanner.builder.detection.collection.ArrayCollectionDefinitionFactory.arrayFactory;
import static com.envimate.mapmate.scanner.builder.detection.collection.NativeJavaCollectionDefinitionFactory.nativeJavaCollectionsFactory;
import static com.envimate.mapmate.scanner.builder.detection.customprimitive.BuiltInPrimitivesFactory.builtInPrimitivesFactory;
