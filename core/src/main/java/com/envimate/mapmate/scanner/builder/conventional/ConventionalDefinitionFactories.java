...
package com.envimate.mapmate.scanner.builder.conventional;

import com.envimate.mapmate.scanner.builder.conventional.annotations.*;
...
import com.envimate.mapmate.scanner.builder.detection.serializedobject.deserialization.ConstructorBasedDeserializationDetector;
...
import static com.envimate.mapmate.scanner.builder.detection.customprimitive.CustomPrimitiveDefinitionFactory.customPrimitiveFactory;
import static com.envimate.mapmate.scanner.builder.detection.customprimitive.deserialization.ClassAnnotationBasedCustomPrimitiveDeserializationDetector.classAnnotationBasedDeserializer;
import static com.envimate.mapmate.scanner.builder.detection.customprimitive.deserialization.ConstructorBasedCustomPrimitiveDeserializationDetector.constructorBased;
import static com.envimate.mapmate.scanner.builder.detection.customprimitive.deserialization.MethodAnnotationBasedCustomPrimitiveDeserializationDetector.annotationBasedDeserializer;
import static com.envimate.mapmate.scanner.builder.detection.customprimitive.deserialization.StaticMethodBasedCustomPrimitiveDeserializationDetector.staticMethodBased;
import static com.envimate.mapmate.scanner.builder.detection.customprimitive.mapping.CustomPrimitiveMappings.customPrimitiveMappings;
import static com.envimate.mapmate.scanner.builder.detection.customprimitive.mapping.UniversalTypeMapper.universalTypeMapper;
import static com.envimate.mapmate.scanner.builder.detection.customprimitive.serialization.ClassAnnotationBasedCustomPrimitiveSerializationDetector.classAnnotationBasedSerializer;
import static com.envimate.mapmate.scanner.builder.detection.customprimitive.serialization.MethodAnnotationBasedCustomPrimitiveSerializationDetector.annotationBasedSerializer;
import static com.envimate.mapmate.scanner.builder.detection.customprimitive.serialization.MethodNameBasedCustomPrimitiveSerializationDetector.methodNameBased;
import static com.envimate.mapmate.scanner.builder.detection.serializedobject.ClassFilter.allowAll;
import static com.envimate.mapmate.scanner.builder.detection.serializedobject.SerializedObjectDefinitionFactory.serializedObjectFactory;
import static com.envimate.mapmate.scanner.builder.detection.serializedobject.deserialization.AnnotationBasedDeserializationDetector.annotationBasedDeserialzer;
import static com.envimate.mapmate.scanner.builder.detection.serializedobject.deserialization.MatchingMethodDeserializationDetector.matchingMethodBased;
import static com.envimate.mapmate.scanner.builder.detection.serializedobject.deserialization.NamedMethodDeserializationDetector.namedMethodBased;
import static com.envimate.mapmate.scanner.builder.detection.serializedobject.deserialization.SingleMethodDeserializationDetector.singleMethodBased;
import static com.envimate.mapmate.scanner.builder.detection.serializedobject.fields.AnnotationFieldDetector.annotationBased;
import static com.envimate.mapmate.scanner.builder.detection.serializedobject.fields.ModifierFieldDetector.modifierBased;
import static com.envimate.mapmate.mapper.definitions.universal.UniversalNumber.universalNumber;
