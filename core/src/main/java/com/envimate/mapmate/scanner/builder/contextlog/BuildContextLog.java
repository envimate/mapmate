...
package com.envimate.mapmate.scanner.builder.contextlog;
...
import static com.envimate.mapmate.scanner.builder.contextlog.ContextLogEntry.logEntry;
...
public final class BuildContextLog implements DefinitionScanLog {
    ...
    public void log(final ResolvedType type,
                    final String message) {
        final ContextLogEntry entry = logEntry(type, this.origin, message);
