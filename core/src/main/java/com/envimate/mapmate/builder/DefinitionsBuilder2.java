...
public final class DefinitionsBuilder2<T> {
    private final Map<ResolvedType, T> map;
    private final String type;

    public static <T> DefinitionsBuilder2<T> definitionsBuilder(final String type) {
        return new DefinitionsBuilder2<>(new HashMap<>(10), type);
    }
