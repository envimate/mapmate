...
public final class NamedFactoryMethodDTODeserializationMethod implements DeserializationDTOMethod {
    ...
    public static DeserializationDTOMethod namedFactoryMethodDTODeserializationMethod(final String name) {
        return new NamedFactoryMethodDTODeserializationMethod(name);
    }

    @Override
    public Object deserialize(final Class<?> targetType, final Map<String, Object> elements) {
